$(function() {
	...
	function deleteBook() {
		...
		var deleteUrl = "files.php?file=" + encodeURI(fileName);
	...
	function downloadBook() {
		var fileName = $(this).siblings(':first').text();
		var url = "http://www.jm.com/pdf/" + fileName;
		window.location = url;
	}
	...
	function startAjaxUpload() {
		...
		$.ajaxFileUpload({
			url:'www.jm.com/uploader/files.php',
			secureuri:false,
	...
	function checkFileName(fileName) {
		if (!fileName || !fileName.toLowerCase().match('(pdf)|(jpg)|(png)$')) {
	...
	function showHtml5View() {
		$('#logo').append('<img src="./img/logo5.jpg" />');
