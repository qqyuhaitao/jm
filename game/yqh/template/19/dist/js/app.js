define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./weixin", "./Lottery", "./video"], function(require, exports, module) {
	var $ = require("./zepto");
	$ = require("./touch");
		...
		init_modle: function() {
			...
			$.get(url, {}, function() {
				if (4308 == activity_id) {
					...
					t.type = "text/javascript", t.src = ("https:" == document.location.protocol ? "https://" : "http://") + "hm.baidu.com/h.js?883e5df898da36becbc7278612991839";
	...
	var i = function() {
		...
		return V.matches = function(t, e) {
			...
			var i, a, r;
			return O.test(t) && (i = C(N.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(q, "<$1></$2>")), e === w && (e = A.test(t) && RegExp.$1), e in H || (e = "*"), r = H[e], r.innerHTML = "" + t, i = C.each(E.call(r.childNodes), function() {
				r.removeChild(this)
			...
			prop: function(t, e) {
				return t = X[t] || t, e === w ? this[0] && this[0][t] : this.each(function(n) {
			...
			css: function(e, n) {
				...
				if ("string" == t(e)) n || 0 === n ? r = c(e) + ":" + d(e, n) : this.each(function() {
					...
					for (_ in e) e[_] || 0 === e[_] ? r += c(_) + ":" + d(_, e[_]) + ";" : this.each(function() {
		...
		}), V.Z.prototype = C.fn, V.uniq = T, V.deserializeValue = b, C.zepto = V, C
	}();
	...
	function(t) {
		...
		function c(e, n) {
			return (n || !e.isDefaultPrevented) && (n || (n = e), t.each(k, function(t, i) {
				var a = n[t];
				e[t] = function() {
					return this[i] = w, a && a.apply(n, arguments)
				}, e[i] = _
		...
		t.fn.delegate = function(t, e, n) {
			...
			return e && !g(e) ? (t.each(e, function(t, e) {
				...
				o && (r = function(t) {
					return l(h, t.type, a), a.apply(this, arguments)
				}), n && (c = function(e) {
	...
	function(t) {
		...
		function u(t) {
			return t && (t = t.split(";", 2)[0]), t && (t == C ? "html" : t == _ ? "json" : y.test(t) ? "script" : w.test(t) && "xml") || "text"
		}
		...
		t.active = 0, t.ajaxJSONP = function(e, n) {
			...
			return n && n.promise(f), t(u).on("load error", function(o, l) {
				clearTimeout(a), t(u).off().remove(), "error" != o.type && i ? r(i[0], f, e, n) : s(null, l || "error", f, e, n), window[c] = d, i && t.isFunction(d) && d(i[0]), d = i = void 0
			...
			i(n), n.crossDomain || (n.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(n.url) && RegExp.$2 != window.location.host), n.url || (n.url = "" + window.location), h(n), n.cache === !1 && (n.url = d(n.url, "_=" + Date.now()));
			var l = n.dataType,
				f = /\?.+=\?/.test(n.url);
			if ("jsonp" == l || f) return f || (n.url = d(n.url, n.jsonp ? n.jsonp + "=?" : n.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(n, a);
			var p, v = n.accepts[l],
				x = {},
				b = function(t, e) {
					x[t.toLowerCase()] = [t, e]
			...
			if (a && a.promise(w), n.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", v || "*/*"), (v = n.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), w.overrideMimeType && w.overrideMimeType(v)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && b("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers)
			...
			if (w.setRequestHeader = b, w.onreadystatechange = function() {
				if (4 == w.readyState) {
					...
					if (w.status >= 200 && 300 > w.status || 304 == w.status || 0 == w.status && "file:" == y) {
						l = l || u(n.mimeType || w.getResponseHeader("content-type")), e = w.responseText;
						try {
			...
			}, o(w, n) === !1) return w.abort(), s(null, "abort", w, n, a), w;
			if (n.xhrFields)
			...
			return n.timeout > 0 && (p = setTimeout(function() {
				w.onreadystatechange = c, w.abort(), s(null, "timeout", w, n, a)
			...
			return r.length > 1 && (s.url = r[0], a = r[1]), s.success = function(e) {
				o.html(a ? t("<div>").html(e.replace(b, "")).find(a) : e), l && l.apply(o, arguments)
			}, t.ajax(s), this
		};
	...
	function(t) {
		...
		function a() {
			s && clearTimeout(s), l && clearTimeout(l), c && clearTimeout(c), u && clearTimeout(u), s = l = c = u = null, h = {}
		}
		...
		t(document).ready(function() {
			...
			"MSGesture" in window && (d = new MSGesture, d.target = document.body), t(document).bind("MSGestureEnd", function(t) {
				...
				(!(v = r(e, "down")) || o(e)) && (m = v ? e : e.touches[0], e.touches && 1 === e.touches.length && h.x2 && (h.x2 = void 0, h.y2 = void 0), p = Date.now(), g = p - (h.last || p), h.el = t("tagName" in m.target ? m.target : m.target.parentNode), s && clearTimeout(s), h.x1 = m.pageX, h.y1 = m.pageY, g > 0 && 250 >= g && (h.isDoubleTap = !0), h.last = p, u = setTimeout(n, f), d && v && d.addPointer(e.pointerId))
			}).on("touchmove MSPointerMove pointermove", function(t) {
				(!(v = r(t, "move")) || o(t)) && (m = v ? t : t.touches[0], i(), h.x2 = m.pageX, h.y2 = m.pageY, x += Math.abs(h.x1 - h.x2), b += Math.abs(h.y1 - h.y2))
			}).on("touchend MSPointerUp pointerup", function(n) {
				(!(v = r(n, "up")) || o(n)) && (i(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? c = setTimeout(function() {
					h.el.trigger("swipe"), h.el.trigger("swipe" + e(h.x1, h.x2, h.y1, h.y2)), h = {}
				}, 0) : "last" in h && (30 > x && 30 > b ? l = setTimeout(function() {
					var e = t.Event("tap");
					e.cancelTouch = a, h.el.trigger(e), h.isDoubleTap ? (h.el && h.el.trigger("doubleTap"), h = {}) : s = setTimeout(function() {
		...
		i = {
			...
			_injectStyles: function(t, e, n, i) {
				var a, o, r, s, l = document.createElement("div"),
					...
					d = "modernizr";
				if (parseInt(n, 10))
					for (; n--;) r = document.createElement("div"), r.id = i ? i[n] : d + (n + 1), l.appendChild(r);
				return a = ["&#173;", '<style id="s', d, '">', t, "</style>"].join(""), l.id = d, (c ? l : u).innerHTML += a, u.appendChild(l), c || (u.style.background = "", u.style.overflow = "hidden", s = docElement.style.overflow, docElement.style.overflow = "hidden", docElement.appendChild(u)), o = e(l, t), c ? l.parentNode.removeChild(l) : (u.parentNode.removeChild(u), docElement.style.overflow = s), !!o
			},
			...
			_scrollStop: function() {
				e("body").addClass("f-ofh"), e(window).on("touchmove", this._scrollControl), e(window).on("scroll", this._scrollControl)
			},
			_scrollStart: function() {
				e("body").removeClass("f-ofh"), e(window).off("touchmove"), e(window).off("scroll")
			},
	...
	var e = t("./zepto"),
		...
		i = {
			...
			height_auto: function(t, n) {
				n = n ? n : e(window).height(), t.children(".page-con").css("height", n)
			}
		};
	return e(function() {
			...
			audio_addEvent: function() {
				...
				if (!(0 >= this._audioNode.length)) {
					...
					e(this._audio).on("play", function() {
						t(i, !0, a), n._handleEvent("audio_play")
					}), e(this._audio).on("pause", function() {
						t(i, !1, a), n._handleEvent("audio_pause")
					})
				}
			},
			media_init: function() {
	...
	return e(window).on("load", function() {
		i._audioNode.find(".btn_audio").on("click", function() {
	...
	haddle_envent_fn = function() {
		...
		}), n._on("video_open", function() {
			var t = r._audio;
			r._audioNode.addClass("z-low"), e(".u-arrow").addClass("f-hide"), e(document.body).css("height", e(window).height()), t && t.pause(), i.page_stop()
		}), n._on("video_close", function() {
			var t = r._audio;
			r._audioNode.removeClass("z-low"), e(".u-arrow").removeClass("f-hide"), e(document.body).css("height", "100%"), t && t.play(), i.page_start()
		})
	}, e(function() {
		haddle_envent_fn()
	})
	...
	function(t) {
		t.fn.ylmap = function(e) {
			...
			return this.each(function() {
				...
				var b = function() {
						l.size() > 0 && (o = new BMap.Map(x.attr("id")), r = new BMap.Point(d, u), s = new BMap.Marker(r), o.enableScrollWheelZoom(), o.enableInertialDragging(), o.centerAndZoom(r, 15), o.addOverlay(s), y(), s.addEventListener("click", function() {
							y()
				...
				open_navigate = function(e) {
					...
					l.removeClass("mapOpen open"), h && h()
	...
	return a
}), define("dist/js/plugins", ["./zepto", "./ylMusic", "./fx", "./weixin", "./Lottery", "./global", "./page", "./media", "./video"], function __plugins(t) {
	var e = t("./zepto");
		...
		s = {
			init: function() {
				e("#coffee_flow").coffee({
					...
					steamHeight: 100,
					steamWidth: 44
				}), o.media_init(), r.video_init();
				var t = {};
				"" != e("#r-wx-title").val() && (t.title = e("#r-wx-title").val()), "" != e("#r-wx-img").val() && (t.img = e("#r-wx-img").val()), "" != e("#r-wx-con").val() && (t.con = e("#r-wx-con").val()), "" != e("#r-wx-link").val() && (t.link = e("#r-wx-link").val()), "" != e("#r-wx-callback").val() && (t.callback = e("#r-wx-callback").val()), i._weixin && e(document.body).wx(t);
				var n = e(".translate-front").data("open");
				if (1 == n) {
					var a = e("#j-mengban")[0],
						l = "./template/19/img/page_01_bg@2x.jpg",
						c = e("#r-cover").val(),
						u = "image",
						d = 640,
						h = e(window).height(),
			...
			start_callback: function() {
				...
				if (a.page_start(), e(document).one("touchstart", function() {
					o._audio.play()
				}), 1 == t) {
		...
		t.fn.coffee = function(e) {
			function n() {
				...
				m > a && (m = r(0, a)), g.css({
					...
					left: m,
					opacity: 0
				}, r(h.steamFlyTime / 2, 1.2 * h.steamFlyTime), u, function() {
					g.remove(), g = null
				})
			}
			...
			var l = null,
				...
				d = t(this),
				h = t.extend({}, t.fn.coffee.defaults, e),
				f = h.steamWidth,
	...
	function(t, e) {
		...
		t.each(g, function(t, n) {
		...
		}), o = p + "transform", b[r = p + "transition-property"] = b[s = p + "transition-duration"] = b[c = p + "transition-delay"] = b[l = p + "transition-timing-function"] = b[u = p + "animation-name"] = b[d = p + "animation-duration"] = b[f = p + "animation-delay"] = b[h = p + "animation-timing-function"] = "", t.fx = {
			...
			var v, y, w, _ = {},
				...
				T = !1;
			if (a === e && (a = t.fx.speeds._default / 1e3), m === e && (m = 0), t.fx.off && (a = 0), "string" == typeof i) _[u] = i, _[d] = a + "s", _[f] = m + "s", _[h] = p || "linear", j = t.fx.animationEnd;
			else {
				y = [];
			...
			return w = function(n) {
				...
				T = !0, t(this).css(b), g && g.call(this)
...
}), define("dist/js/video", ["./zepto", "./global"], function(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = {
			_video: e(".j-video"),
